...
class DialogScenesEditor extends Editor {	
	...
	var cameraLabel : Texture2D = EditorGUIUtility.Load("Hell Tap Entertainment/Localized Dialogs/scenesLabel.png") as Texture2D;
	
	// EDITOR ANIMATION TIME
	var EditorTime : LDCEditorTimeDS = new LDCEditorTimeDS();
	class LDCEditorTimeDS{
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		function EditorAnimationUpdate(){
		    ...
		    if( target != null && !EditorApplication.isPlaying ) {
		    	...
		    	var dc : DialogScenes = target as DialogScenes;
			...
			EditorGUILayout.BeginHorizontal();
				...
				EditorGUILayout.BeginVertical();
					...
					if(!Application.isPlaying){
						GUILayout.Label("LDC Graphics Library which can be used in your dialogs as Background Layers.", GUILayout.MinWidth(600), GUILayout.MaxWidth(600));
					} else {
				...
				if(actor){ // make sure style is not null
					...
					EditorGUILayout.BeginHorizontal();
						...
						EditorGUILayout.BeginVertical(GUILayout.MaxWidth(120));
							...
							// Actor Name
							GUILayout.Label("BG Name: ", "BoldLabel", GUILayout.MaxWidth(100));
	...
	function AddNewCastGroup(){
		...
		newCastGroup.name = "New Scene Group";
