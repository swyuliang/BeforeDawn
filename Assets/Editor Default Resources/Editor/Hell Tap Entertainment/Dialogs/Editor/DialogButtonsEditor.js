////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// 	DialogButtonsEditor.js
//
//	Editor for DialogButtons.js
//
...
@CustomEditor (DialogButtons)
class DialogButtonsEditor extends Editor {	
	...
	var cameraLabel : Texture2D = EditorGUIUtility.Load("Hell Tap Entertainment/Localized Dialogs/buttonIconLabel.png") as Texture2D;
	
	// EDITOR ANIMATION TIME
	var EditorTime : LDCEditorTimeDB = new LDCEditorTimeDB();
	class LDCEditorTimeDB{
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		function EditorAnimationUpdate(){
		    ...
		    if( target != null && !EditorApplication.isPlaying ) {
		    	...
		    	var dc : DialogButtons = target as DialogButtons;
        ...
        if( Selection.activeGameObject && target != null && target.GetComponent(DialogCast) ) {
			...
			EditorGUILayout.BeginHorizontal();
				...
				EditorGUILayout.BeginVertical();
					GUILayout.Label("Dialog Buttons", "BoldLabel", GUILayout.MinWidth(190), GUILayout.MaxWidth(190));
					if(!Application.isPlaying){
						GUILayout.Label("LDC Graphics Library which can be used in your dialogs as buttons, icons and items.", GUILayout.MinWidth(600), GUILayout.MaxWidth(600));
					} else {
	...
	function DrawActorGroup( dca : DialogCastGroup ){
		...
		EditorGUILayout.BeginHorizontal();
			GUILayout.Label("", GUILayout.MaxWidth(5));	// indent
			GUILayout.Label( "The Buttons", "BoldLabel");
			GUILayout.Label("", GUILayout.MaxWidth(5));	// indent
		EditorGUILayout.EndHorizontal();
				...
				if(actor){ // make sure style is not null
					...
					EditorGUILayout.BeginHorizontal();
						...
						EditorGUILayout.BeginVertical(GUILayout.MaxWidth(120));
							...
							// Actor Name
							GUILayout.Label("Button Name: ", "BoldLabel", GUILayout.MaxWidth(100));
	...
	function AddNewCastGroup(){
		...
		newCastGroup.name = "New Button Group";
